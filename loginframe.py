...
from PyQt5.QtGui import QKeyEvent, QKeySequence, QRegExpValidator ,QFont
...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		self.label.setGeometry(QtCore.QRect(80, 50, 47, 21))
		self.label.setObjectName("label")
		self.label_2 = QtWidgets.QLabel(self.centralwidget)
		self.label_2.setGeometry(QtCore.QRect(80, 100, 47, 21))
		self.label_2.setObjectName("label_2")
		self.label_3 = QtWidgets.QLabel(self.centralwidget)
		self.label_3.setGeometry(QtCore.QRect(50, 150, 61, 21))
	...
	def retranslateUi(self, MainWindow):
		...
		self.pushButton.setFont(QFont("Arial",10,50))
		self.pushButton.setText(_translate("MainWindow", "ENTER"))
		self.label.setFont(QFont("Arial",9,70))
		self.label_2.setFont(QFont("Arial",9,70))
		self.label_3.setFont(QFont("Arial",9,70))
